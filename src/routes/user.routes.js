...
import { add_food, create_category, get_restaurant_info, get_user_info } from "../controllers/user.controller.js"
...
user_routes.post("/add_food", validate_auth, addFoodRules, add_food)
